...
import { Table, Tag, Space, Input, Popconfirm, Select, Avatar , Button ,Statistic} from 'antd';
...
const columns = [
  ...
  },
  {
    ...
    key: 'name',
    align:'center',
    render: text => text==="male"?<MyIcon type='icon-nan' style={{fontSize:24,color:'Blue'}}/>
    :
  ...
  },
  {
    ...
    key: 'address',
    render:()=>(
      <Statistic title="月内违规次数" value={0} suffix="/ 10" />
    )
  },
  {
    title: '操作',
    ...
    render: () => (
      <Space size="middle">
        ...
        <Popconfirm title=" 确定关停此账号 ？" okText="Yes" cancelText="No">
          <Button type="primary" danger>永久封停</Button>
        </Popconfirm>
      </Space>
    ),
  },
